...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const forgeGatewayUrl = Deno.env.get("EXPERT_FORGE_GATEWAY_URL") || Deno.env.get("EXPERT_FORGE_URL") || "https://nhfocnjtgwuamelovncq.supabase.co/functions/v1/api-gateway";
