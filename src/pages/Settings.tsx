                            ...
                            <main className="p-3 sm:p-4 lg:p-6 pb-24 lg:pb-6 space-y-3 sm:space-y-4 max-w-3xl mx-auto">
                                ...
                                {/* JARVIS Profile */}
                                      <SettingsSection
                                                  ...
                                                  title="Perfil JARVIS"
                                                  description="Personaliza como JARVIS te conoce"
                                                >
                                                  <ProfileSettingsCard />
                                      </SettingsSection>SettingsSection>
                                ...
                                {/* iCloud Calendar */}
                                      <SettingsSection
                                                  ...
                                                  description="Sincronizacion con Apple Calendar"
                                                >
                                ...
                                {/* Accesibilidad */}
                                      <SettingsSection
                                                  ...
                                                  title="Accesibilidad"
                                                  description="Tamano de texto e idioma"
                                                >
                                ...
                                {/* Visibilidad del menu */}
                                      <SettingsSection
                                                  ...
                                                  title="Visibilidad del menu"
                                                  description="Elige que elementos aparecen en el menu lateral"
                                                >
                                                  <MenuVisibilityCard />
                                      </SettingsSection>SettingsSection>
                                ...
                                {/* Tarjetas del Dashboard */}
                                      <SettingsSection
                                                  ...
                                                  description="Elige que tarjetas se muestran en tu Dashboard"
                                                >
                                ...
                                {/* Exportar datos */}
                                      <SettingsSection
                                                  ...
                                                  description="Descarga tu informacion"
                                                >
                                                  <DataExportCard />
                                      </SettingsSection>SettingsSection>
                            </main>main>
